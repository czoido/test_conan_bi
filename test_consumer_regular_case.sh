...
build_name="test_consumer_regular_case"
use_force=""
...
conan export libR
conan export consumer_regular

conan graph lock consumer_regular/1.0@ -r conan-tmp

conan graph build-order conan.lock --build=missing

cat conan.lock

conan install consumer_regular/1.0@ --lockfile=conan.lock --build missing -r conan-tmp

conan upload 'libX' --all -r conan-tmp --confirm ${use_force}
conan upload 'libR' --all -r conan-tmp --confirm  ${use_force}
conan upload 'consumer_regular' --all -r conan-tmp --confirm ${use_force}
