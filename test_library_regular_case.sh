...
# libR package id is affected --> we rebuild in a second job with consecutive number
# new binaries for libR are uploaded but the recipe is the same
...
build_name="test_library_regular_case"
use_force=""
